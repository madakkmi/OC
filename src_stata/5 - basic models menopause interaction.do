            ...
            * check if it is a biomarker with aliquot available
            if strpos("`biomarkers_with_aliquotes'", "`col'") > 0 {
                ...
                * get the name of the aliquot variable, eg, _x30620_aliqout
                ...
                logit `outcome_var' c.`col'  `interact_var'#c.`col'  `adjust_vars' c.`fasttime' _x`aliquot_var'_aliquot
                
            }
            else {
                
               logit `outcome_var' c.`col'  `interact_var'#c.`col'  `adjust_vars' c.`fasttime'
            }
        }
        else {
