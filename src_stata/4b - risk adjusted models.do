/****************************************************************************************************************************************
Basic + known risk factors adjusted models for overall OC and for 4 subtypes
...
log using "OC\reports\risk_factor_adjusted_models.smcl", replace
...
local adjust_vars `basic_adjust_vars' family_bc_pc c.x2734_nliveb x2784_ocp x20004__1362_tl  i.x738_hhinc
...
foreach outcome_var in `outcome_variables' {
    set more off
    tempname results
    postfile `results' str20 model str20 exposure str20 var_type n n_cancer beta se lci uci double p using "OC\reports\basic_plus_risk_binary_and_continuous_for_`outcome_var'.dta", replace
    ...
    foreach col in `binary_features' {
        ...
        test `col'
        local p = r(p)
        post `results' ("basic_plus_risk") ("`col'") ("binary") (`n') (`n_cancer') (`beta') (`se') (`lci') (`uci') (`p')
    }
    ...
    foreach col in `continuous_features' {
        ...
        * check if it is a biomarker
        ...
        post `results' ("basic_plus_risk") ("`col'") ("continuous") (`n') (`n_cancer') (`beta') (`se') (`lci') (`uci') (`p')
    ...
    set more off
    tempname results
    postfile `results' str20 model str20 exposure str20 var_type n n_cancer double df double chi2 double p using "OC\reports\basic_plus_risk_categorical_for_`outcome_var'.dta", replace
    ...
    foreach col in `categorical_features' {
        ...
        count if e(sample) & `outcome_var' == 1
        local n_cancer = r(N)
        post `results' ("basic_plus_risk") ("`col'") ("categorical") (`n') (`n_cancer') (`df') (`chi2') (`p')
    }
    ...
    set more off
    tempname results
    postfile `results' str20 model str20 exposure n n_cancer beta se lci uci double p using "OC\reports\basic_plus_risk_categorical_levels_for_`outcome_var'.dta", replace
    ...
    foreach col in `categorical_features' {
        ...
        foreach lev of local levels {
            ...
            if `beta' == 0 & `se' == 0 {
                ...
                local n_cancer = r(N)
                post `results' ("basic_plus_risk") ("`col'=`lev'") (`n') (`n_cancer') (0) (0) (0) (0) (.)
            } 
            else {
                count if `col' == `lev' & e(sample)
                local n = r(N)
                ...
                test `lev'.`col'
                local p = r(p)
                post `results' ("basic_plus_risk") ("`col'=`lev'") (`n') (`n_cancer') (`beta') (`se') (`lci') (`uci') (`p')
            }
        }
    }
